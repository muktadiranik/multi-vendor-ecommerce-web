...
const UpdateListYourBikeModal2 = ({ getImage, setBikeDetails }) => {
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-12 p-4 mt-6">
        <div className="col-span-full">
      ...
      <div className="justify-center grid grid-cols-12 w-full p-4">
        <div className="col-span-full">
          <div className="w-full">
            <form action="" onSubmit={handleSubmit(onSubmit)}>
              <label className="flex justify-center w-full h-full px-4 transition bg-white border-2 border-gray border-dashed rounded-md appearance-none cursor-pointer hover:border-gray-400 focus:outline-none">
                <div className="">
                  {updateProduct?.products?.edges[0]?.node?.image &&
                  !productImage ? (
                    <Image
                      className="mx-auto mt-8 mb-4"
                      src={updateProduct?.products?.edges[0]?.node?.image}
                      alt=""
                      height={200}
                      width={200}
                    />
...
export default UpdateListYourBikeModal2;
