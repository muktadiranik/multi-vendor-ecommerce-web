...
const UpdateListYourBikeModal3 = ({ getLastModalData, closeRef, setImage }) => {
  ...
  return (
    <div>
      ...
      <p className="mt-8 mb-4 text-lg font-medium text-left">
...
export default UpdateListYourBikeModal3;
