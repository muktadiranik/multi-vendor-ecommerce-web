...
const UpdateBikeModalDetails = ({ getbikeDetials }) => {
  ...
  const schema = yup.object().shape({
    ...
    description: yup
      ...
      .max(250)
      .min(1),
    conditions: yup.string().required("Conditions is required").max(50).min(1),
  ...
  return (
    <div>
      <div className="flex justify-between">
        <h1 className="text-2xl font-medium">Update your bike</h1>
      </div>
      ...
      <p className="mt-9 text-xl font-medium text-left">
            ...
            <div className="">
              <div className="grid grid-cols-2 gap-1 xl:gap-4">
                <div className="col-span-2 xl:col-span-1 form-control rounded-[10px] w-full">
                  ...
                  <input
                    type="text"
                    defaultValue={
                      updateProduct?.products?.edges[0]?.node?.brand
                    }
                ...
                <div className="col-span-2 xl:col-span-1 form-control rounded-[10px] w-full">
                  ...
                  <input
                    type="text"
                    defaultValue={
                      updateProduct?.products?.edges[0]?.node?.model
                    }
              ...
              <div>
                <div className="form-control ">
                  ...
                  <textarea
                    defaultValue={
                      updateProduct?.products?.edges[0]?.node?.description
                    }
                    className=" py-4 px-6 border border-gray rounded-[10px] placeholder:text-[14px] w-full"
              ...
              <div className="grid grid-cols-2 gap-1 xl:gap-4">
                <div className=" col-span-2 xl:col-span-1 form-control rounded-[10px] w-full mt-4">
                  ...
                  <input
                    type="text"
                    defaultValue={
                      updateProduct?.products?.edges[0]?.node?.condition
                    }
                ...
                <div className="col-span-2 xl:col-span-1 form-control rounded-[10px] w-full mt-4">
                  ...
                  <select
                    ...
                    defaultChecked={
                      updateProduct?.products?.edges[0]?.node?.productType?.id
                    }
                    className="py-4 px-6 border border-gray rounded-[10px] placeholder:text-[14px] w-full"
                    {...register("bikeType")}>
                    {productType}
              ...
              <div className="grid grid-cols-2 gap-1 xl:gap-4">
                <div className=" col-span-2 xl:col-span-1 form-control rounded-[10px] w-full mt-4">
                  ...
                  <select
                    placeholder="Rider height"
                    defaultChecked={
                      updateProduct?.products?.edges[0]?.node?.size?.id
                    }
                    className="py-4 px-6 border border-gray rounded-[10px] placeholder:text-[14px] w-full"
                    {...register("bikeSize")}>
                    {productSize}
                ...
                <div className="col-span-2 xl:col-span-1 form-control rounded-[10px] w-full mt-4">
                  ...
                  <input
                    ...
                    defaultValue={
                      updateProduct?.products?.edges[0]?.node?.stock
                    }
                    className="py-4 px-6 border border-gray rounded-[10px] placeholder:text-[14px] w-full "
                    {...register("stock")}
                  />
...
export default UpdateBikeModalDetails;
